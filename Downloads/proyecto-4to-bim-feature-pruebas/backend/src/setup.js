...
const dbName = 'talentbridge_in5bm';
...
async function main() {
  ...
  const schemaQuery = `
    ...
    DO $$ BEGIN
      CREATE TYPE nivel_pregunta_enum AS ENUM (
        'Basico',
        'Intermedio',
        'Avanzado'
      );
  ...
  console.log(
    'Las 10 tablas de TalentBridge han sido creadas y enlazadas correctamente.'
  );
}

...
export const routes: Routes = [
  ...
  // --- RUTAS DE ADMINISTRADOR ---
  {
    ...
    children: [
      ...
      },
      {
        path: 'usuarios',
        loadComponent: () =>
          import('./pages/admin-dashboard/components/admin-users-form/admin-users-form.component').then(m => m.AdminUsersForm)
      },
      {
        path: 'notificaciones',
        loadComponent: () =>
  ...
  // --- RUTAS DE EMPRESA (Apunta directamente al componente funcional de Admin) ---
  {
    path: 'empresa',
